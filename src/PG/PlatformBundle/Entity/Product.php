 ...
 * @ORM\Entity(repositoryClass="PG\PlatformBundle\Repository\ProductRepository")
...
class Product
{
     ...
     * @Assert\Length(min=3, minMessage="Le nom du produit doit faire au moins {{ limit }} caractères.")
     */
    private $name;
